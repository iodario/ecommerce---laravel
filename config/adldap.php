            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'account_prefix' => env('ADLDAP_ACCOUNT_PREFIX', 'uid'),
                ...
                */
                ...
                'account_suffix' => env('ADLDAP_ACCOUNT_SUFFIX', ',ou=people,dc=fmed,dc=uba,dc=ar'),
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', 'ldap.fmed.uba.ar')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'dc=ldap,dc=fmed,dc=uba,dc=ar'),

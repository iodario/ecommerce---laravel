...
@section('scripts')
<script>
    globalId = '<?php echo isset($mediopago->idmediopago) && $mediopago->idmediopago > 0 ? $mediopago->idmediopago : 0; ?>';
    <?php $globalId = isset($mediopago->idmediopago) ? $mediopago->idmediopago : "0"; ?>
        ...
        <form id="form1" method="POST">
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    ...
                    <input type="text" id="txtClavePublica" name="txtClavePublica" class="form-control" value="{{ $mercadopago->clave_publica }}" required>
                </div>
                <div class="form-group col-lg-6">
                    <label>Token de acceso:</label>
                    <input type="text" id="txtToken" name="txtTokenAcceso" class="form-control" value="{{ $mercadopago->token_acceso}}" required>
                </div>
            </div>

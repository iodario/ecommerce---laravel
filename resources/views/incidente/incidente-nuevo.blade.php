...
@section('scripts')
<script>
    globalId = '<?php echo isset($incidente->idincidente) && $incidente->idincidente > 0 ? $incidente->idincidente : 0; ?>';
    <?php $globalId = isset($incidente->idincidente) ? $incidente->idincidente : "0"; ?>
</script>
@endsection
@section('breadcrumb')
<ol class="breadcrumb">
    ...
    <form id="form1" method="POST">
        <div class="row">
            ...
            <div class="form-group col-lg-6">
                ...
                <textarea type="text" id="txtDescripcion" name="txtDescripcion" class="form-control" rows="100" cols="100" required style="padding:50px;"></textarea>
            </div>
        </div>

...
<ol class="toolbar">
    ...
    <li class="btn-item"><a title="Salir" href="/admin/sucursales" class="fas fa-sign-out-alt" aria-hidden="true" onclick="javascript: $('#modalSalir').modal('toggle');"><span>Salir</span></a></li>
</ol>
<script>
function fsalir(){
        ...
        <form id="form1" method="POST">
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    <label>Nombre: *</label>
                    <input type="text" id="txtNombre" name="txtNombre" class="form-control" value="{{ $sucursal->nombre or '' }}" required>
                </div>
                <div class="form-group col-lg-6">
                    <label>Direcci&oacute;n: *</label>
                    <input type="text" id="txtDireccion" name="txtDireccion" class="form-control" value="{{ $sucursal->direccion or '' }}" required>
                </div>
                <div class="form-group col-lg-6">
                    <label>Localidad: *</label>
                    <select id="lstLocalidad" name="lstLocalidad" class="form-control selectpicker" data-live-search="true" required>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select id="lstProvincia" name="lstProvincia" class="form-control selectpicker" data-live-search="true" required>

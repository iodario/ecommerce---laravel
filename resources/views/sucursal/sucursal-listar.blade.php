...
<ol class="toolbar">
    ...
    <li class="btn-item"><a title="Recargar" href="/admin/sucursales" class="fa fa-refresh" aria-hidden="true" onclick='window.location.replace("/admin/sucursales");'><span>Recargar</span></a></li>
</ol>
@endsection
@section('contenido')
<?php

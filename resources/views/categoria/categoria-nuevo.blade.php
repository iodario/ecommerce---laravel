        ...
        <form id="form1" method="POST">
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select id="lstPadre" name="lstPadre" class="form-control selectpicker" data-live-search="true">
                        <option selected value="0">-</option>
                        @for ($i = 0; $i < count($array_categorias); $i++)
                            @if (isset($categoria) and $array_categorias[$i]->idcategoria == $categoria->fk_idpadre)
